	...
	public class VisualLoader extends Loader implements IClonable
	{
		...
		public function loadURL($url:String, $context:LoaderContext = null):void
		{
			...
			try {
				...
				OutputManager.send("Unable to load " + this.strURL + "!","warning",ClassUtil.getDisplayClassName(this));
			}
		}
		...
		private function recastEvent($event:*):Event
		{
			...
			return new LoaderEvent(VisualLoader.OBJ_REPLACEMENTS.get($event.type),this,objDetails);
		}
		/*
		Event Handlers
		*/

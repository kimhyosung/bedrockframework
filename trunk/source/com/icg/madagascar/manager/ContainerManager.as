package com.icg.madagascar.manager
{
	...
	public class ContainerManager extends StaticWidget
	{
		...
		private static  var OUTPUT:Outputter=new Outputter(ContainerManager);
		...
		*/
		public static function swapChildren($name1:String,$name2:String)
		{
			...
			if (objChild1.parent === objChild2.parent) {
				...
				ContainerManager.OUTPUT.output("Parent containers do not match!","error");
			}
		}
		public static function swapTo($name:String,$depth:Number)
		{
			...
			try {
				...
				ContainerManager.OUTPUT.output($e.message + " Swap failed!","warning");
			}
		}

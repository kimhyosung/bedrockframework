...
{
	import com.icg.madagascar.dispatcher.IDispatcher;
	...
	public class DispatcherWidget extends EventDispatcher implements IEventDispatcher
	{
		private var strClassName:String;
		private var bolOutputSilenced:Boolean;
		private var bolOutputEvents:Boolean;

		public function DispatcherWidget($outputConstruction:Boolean = true)
		{

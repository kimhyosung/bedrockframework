package com.bedrockframework.engine.delegate
{
	...
	public class DefaultPathDelegate extends BasicWidget implements IPathDelegate
	{
		...
		{
			var strPath:String = BedrockEngine.config.getPathValue( BedrockData.RESOURCE_BUNDLE_PATH );
		...
		{
			var strPath:String = BedrockEngine.config.getPathValue( BedrockData.SHARED_PATH );

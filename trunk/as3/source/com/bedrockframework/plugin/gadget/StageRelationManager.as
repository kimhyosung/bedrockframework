package com.bedrockframework.plugin.gadget
{
	...
	*/
	...
	import com.bedrockframework.plugin.data.StageRelationData;
	...
	public class StageRelationManager extends StaticWidget
	{
		/*
		...
		*/
	 	...
	 	public static function add( $data:StageRelationData ):void
		{
			if (StageRelationManager.__objStage != null) {
				StageRelationManager.__mapTargets.saveValue( $data.alias, $data );
				StageRelationManager.updateTarget( $data);
			} else {
				Logger.log( StageRelationManager, LogLevel.ERROR, "Stage value is null!" );
			}
		}
		public static function remove( $alias:String ):void
		{
			StageRelationManager.__mapTargets.removeValue($alias);
		}
		public static function update( $alias:String ):void
		{
			StageRelationManager.updateTarget( StageRelationManager.__mapTargets.getValue( $alias ) );
		}
		/*

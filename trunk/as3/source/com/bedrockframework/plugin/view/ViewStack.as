package com.bedrockframework.plugin.view
{
	...
	public class ViewStack extends SpriteWidget
	{
		...
		*/
		...
		public function initialize($data:ViewStackData):void
		{
			...
			if ( this.data.startingAlias != null ) {
				var numIndex:int = ArrayUtil.findIndex( this.data.stack, this.data.startingAlias, "id" );
				if ( numIndex != -1 ) {
		...
		*/
		...
		{
			var numIndex:int = ArrayUtil.findIndex( this.data.stack, $id, "id" );
			if ( numIndex != -1 ) {
		...
		*/
		...
		public function getByAlias( $id:String ):Object
		{

package com.bedrockframework.plugin.data
{
	...
	public class ViewStackData
	{
		...
		public function addToStack($view:IView, $id:String = null, $initializeData:Object = null, $introData:Object = null, $outroData:Object = null):void
		{
			this._arrStack.push( { view:$view, id:$id, initialize:$initializeData, intro:$introData, outro:$outroData } );
		}
